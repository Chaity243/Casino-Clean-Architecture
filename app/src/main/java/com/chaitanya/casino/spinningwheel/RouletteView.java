...
public class RouletteView extends View implements RouletteRotation.RotationListener {
    ...
    private RouletteRotation wheelRotation;
    ...
    public RouletteView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void rotate(float maxAngle, long duration, long interval) {
        ...
        wheelRotation = RouletteRotation
